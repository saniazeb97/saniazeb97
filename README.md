...
|---|---|
| **[InsightBot](https://github.com/saniazeb97/insightbot)** | LangChain SQL agent that generates and runs live SQL from natural-language questions |
| **[NYC Trends Analysis](https://github.com/saniazeb97/nyc-trends-tableau)** | EDA, correlation analysis, and Tableau dashboards across Airbnb, Census, and NYPD crime data |
